...
public class OrangeHRMStepDefinitions {
    ...
    public void kullaniciInvalidCredentialsGirer(DataTable table) {
        ...
        for (int row = 1; row < table.height(); row++) {//rowları doner
           // for(int col = 1; col < table.width(); col++) { sutunları doner}
    ...
    /*
    row=1 için:
1.satır, 0.indeksteki hücreyi al username'e ata
1.satır, 1.indeksteki hücreyi al password'e ata
1.satır, 2.indeksteki hücreyi al errormessage'e ata
     */
